...
export const PlaylistCard = ({
  ...
  return (
    <Card
      onClick={() => {}}
      className="group w-fit px-4 cursor-pointer hover:bg-surface-hover transition-all duration-400 hover:-translate-y-1.5"
    >
      <div className="overflow-hidden rounded-md relative w-62.5 h-62.5">
        ...
        <Image
          className="rounded-md group-hover:scale-105 group-hover:blur-xs transition-all duration-300 w-full h-full object-cover"
          src={playlistImage}
          width={250}
          height={250}
          alt={playlistName}
