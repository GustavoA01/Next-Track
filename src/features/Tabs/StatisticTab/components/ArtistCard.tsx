...
export const ArtistCard = ({
  ...
  return (
    <Link
      ...
      className="group animate-slide-in-down"
    ...
    >
      <div className="relative overflow-hidden rounded-lg min-w-37.5 min-h-37.5 sm:w-full md:h-auto bg-surface">
        ...
        <Image
          ...
          className={cn('group-hover:scale-110 aspect-square transition-all duration-300 rounded-lg md:w-full md:h-auto object-cover', hasImageLoaded ? 'opacity-100' : 'opacity-0')}
        />
        <div
          style={{
